var Weglot = function() {
  ...
  function i(e) {
      ...
      function n(e, n, i) {
          ...
          l && "dev" !== a && function(e, t, n) {
              ...
              window.Weglot && window.Weglot.options && (a.projectInfo = ["host", "api_key", "url_type", "technology_name", "technology_id", "is_connect", "auto_switch"].reduce((function(e, t) {
                  var n;
                  return Object.assign({}, e, ((n = {})[t] = window.Weglot.options[t],
                  n))
              }
              ), {}));
  ...
  function u(e) {
      for (var t = 0, n = l; t < n.length; t += 1) {
          var r = n[t];
          if (-1 !== e.indexOf(r))
              return !0
      }
  ...
  function f(e, t, n) {
      var r = t && t[e];
      if (r && r.textContent === t.textContent)
          return r.result;
      var o = n(t);
      return t ? (t[e] = {
          result: o,
  ...
  function d(e) {
      return f("__validMergeNodes", e, (function(e) {
          return e && _(e) && g(e) && !function(e) {
              return f("__containsNoTranslateNodes", e, (function(e) {
                  return 1 === e.nodeType && (!!e.querySelector("[" + n.noTranslateAttribute + "]") || h(e))
              }
              ))
          }(e)
      }
  ...
  function g(e, t) {
      return void 0 === t && (t = !0),
      f("__validTextNodes", e, (function(e) {
          return !(!e.textContent || t && !e.textContent.trim() || -1 !== e.textContent.indexOf("BESbswy") || e.parentNode && e.parentNode.nodeName && -1 !== ["script", "style", "noscript"].indexOf(e.parentNode.nodeName.toLowerCase()) || function(e) {
              if (!(e = e.trim()))
                  return !1;
              var t = e.charAt(0);
              if ("[" !== t && "{" !== t)
  ...
  function p(e) {
      try {
          if (n.mergedSelectorRemove && k(e, n.mergedSelectorRemove))
              return !1
      } catch (e) {}
      return !(!n.mergeNodes || -1 === n.mergeNodes.indexOf(e.nodeName)) || (e.dataset && e.dataset.wgMerge || n.selectorMerging && e.matches && e.matches(n.selectorMerging))
  }
  function _(e) {
      return f("__onlyInlineChildsNodes", e, (function(e) {
          if (!e.childNodes)
              return !0;
  ...
  function h(e) {
      ...
      for (var t = 0, n = e.children; t < n.length; t += 1) {
          var r = n[t];
          if (r.wgNoTranslate || h(r))
              return !0
      }
      return !1
  }
  function m(e) {
      return !!e && (!!e.wgNoTranslate || m(e.parentNode))
  }
  function v(e) {
      if (!e)
          return !1;
      var t = e.closest ? e : e.parentNode;
      return !(!t || !k(t, "[" + n.noTranslateAttribute + "]")) || m(e)
  }
  var y = function(e, t) {
      return function(n, r) {
          try {
              var o = r;
              return -1 !== o.indexOf(":") && (o = o.replace(/([^\\]):/g, "$1\\:")),
              n[e] ? n[e](o) : t
          } catch (o) {
              try {
                  return n[e] ? n[e](r) : t
  ...
  function C(e) {
      ...
      !n.whitelist || !n.whitelist.length)
          return [].concat(function(e) {
              ...
              if (e !== document.documentElement || !document.title || !t || v(t))
                  return [];
              return [{
      ...
      var r = n.whitelist.map((function(e) {
          return e.value
      }
      )).join(",");
      if (k(t, r))
          return O(t);
      for (var o = [], a = 0, i = w(t, r); a < i.length; a += 1) {
          var s = i[a];
          [].push.apply(o, O(s))
      }
      return o
  ...
  function O(e) {
      return [].concat(function(e) {
          ...
          return H.forEach((function(n) {
              for (var r, o, a, i = n.attribute, s = n.type, c = n.selectors, l = 0, u = (r = e,
              o = [],
              a = c.join(","),
          ...
          var t, r = [], o = n.translation_engine >= 2, a = document.createTreeWalker(e, 4, S, !1);
          for (; t = a.nextNode(); ) {
              var i = (o && (p(t.parentNode) || t.parentNode.childNodes.length > 1) ? L : N)(t, a);
              i && r.push(i)
          }
          return r
      }(e))
  ...
  function S(e) {
      return !g(e) || v(e) ? NodeFilter.FILTER_REJECT : NodeFilter.FILTER_ACCEPT
  }
  function L(e, t) {
      var r = function(e) {
          if (e.wgResolved)
      ...
      var a = function(e, t) {
          ...
          if (e) {
              return e.wgResolved = !0,
              [e, (a.innerHTML || a.textContent || "").replace(/<!--[^>]*-->/g, ""), r]
          }
      }(e, t);
      if (a) {
          var i = a[0]
  ...
  function R(e, t, n, r, o) {
      if (1 === e.nodeType) {
          ...
          return e.innerHTML = "",
          void e.appendChild(a)
      }
      if (x(t) && !x(r)) {
          if (!e.parentNode)
              return s.warn("Unable to translate some words, please contact support@weglot.com."),
              void s.warn(e, {
                  sendToDatadog: !1
              });
          if (1 === e.parentNode.childNodes.length)
              return e.parentNode.weglot = e.weglot,
              void (o ? o.push(e.parentNode) : R(e.parentNode, t, n, r));
          ...
          if (!i || i.innerHTML !== t) {
              ...
              o ? o.push(c) : R(e.parentNode, t, n, r)
          }
      } else
          e.textContent = t
  }
      ...
      for (var o = t.childNodes.length, a = 0; a < o; a++) {
          ...
          if (i = I(c)) {
              ...
              var u = l.used ? l.child.cloneNode(!0) : l.child
                , f = P(u, c, n);
              if (f.contains(u))
                  return s.error("There is an HTML error in the translation of: " + e.innerHTML.toString()),
                  r;
              u.innerHTML = "",
              u.appendChild(f),
              r.appendChild(u),
  ...
  function W(e) {
      ...
      if (e.media_enabled && t.push({
          ...
          attribute: {
              ...
              set: function(e, t, n) {
                  ...
                  if (t === n) {
                      if (e.removeAttribute("data-wgtranslated"),
                      e.isChanged) {
                          var a = "" + t + (e.queryString ? "?" + e.queryString : "");
                          e.setAttribute("src", a),
                          F(e, a),
                          e.hasAttribute("wgsrcset") && (e.setAttribute("srcset", e.getAttribute("wgsrcset") || e.dataset.srcset),
                          e.removeAttribute("wgsrcset"))
                      }
                  } else
                      r.split("?")[0] !== t && n !== t && (e.setAttribute("src", t),
                      F(e, t),
                      e.hasAttribute("srcset") && (e.setAttribute("wgsrcset", o),
      ...
      e.external_enabled) {
          var n = U(function() {
              ...
              return r ? r[1] : (s.warn("[Weglot] Unable to get current hostname"),
              t)
          }());
          t.push({
              type: 10,
              ...
              attribute: {
                  name: "href",
                  get: function(e) {
                      if (!e.href || !e.href.split)
                          return "";
                      var t = e.href.split("/")[2];
                      return t && U(t) !== n ? e.getAttribute("href") : ""
                  },
                  set: function(e, t) {
      ...
      if (e.extra_definitions && e.extra_definitions.length)
          for (var r = function() {
              ...
              }) : s.warn("Each extra definition option needs at least {attribute,selector} https://bit.ly/2yDsLxy", {
                  sendToDatadog: !1
              })
          }, o = 0, a = e.extra_definitions; o < a.length; o += 1)
              r();
      return t
  }
  S.acceptNode = S;
  ...
  function M(e, r) {
      ...
      n.document = e,
      n.mergeNodes = (o = r.translation_engine,
      t.v2.unshift("#text", "#comment"),
      Object.keys(t).reduce((function(e, n, r) {
          return o >= r + 1 && [].push.apply(e, t[n]),
          e
      }
      ), [])),
      Array.isArray(n.extra_merged_selectors) && (n.selectorMerging = r.extra_merged_selectors.filter((function(e) {
          return e && "string" == typeof e
      }
      )).join(",")),
      r.merged_selectors_remove && (n.mergedSelectorRemove = r.merged_selectors_remove.map((function(e) {
          return e.value
      }
      )).join(",")),
      {
  ...
  z.set = function(e) {
      ...
      if (q && t) {
          var s = i.host
            , c = i.is_connect
            , l = i.subdirectory;
          t = t.replace(/[^+#$&^`|]/g, encodeURIComponent).replace("(", "%28").replace(")", "%29"),
          n = n.toString().replace(/[^+#$&/:<-[\]-}]/g, encodeURIComponent),
          !r && c && s && (r = l ? s : s.split("www.").pop());
          var u = r ? ";domain=" + r : ""
            , f = a ? ";expires=" + a : ""
            , d = ";path=/" + (o || "");
          document.cookie = t + "=" + n + u + d + f + ";SameSite=None;Secure"
      }
  }
  ,
  z.get = function(e) {
